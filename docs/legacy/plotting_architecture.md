...
> **📖 For comprehensive PlotGrid documentation, see [`plotgrid.md`](plotgrid.md)**  
> **📚 For historical migration information, see [`historical_migrations.md`](historical_migrations.md)**

This document focuses on **architectural decisions** and **code reuse patterns** for developers working on the plotting module.
...
```bash
# Generate registry (markdown format)
python3 scripts/generate_function_registry.py

# Output file:
# - docs/function_registry.md (markdown for AI assistants and developers)
```
