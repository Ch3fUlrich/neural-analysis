...
class TestHeatmap:
    ...
    def test_plot_heatmap_with_values(self):
        ...
        ax = plot_heatmap(
            data, show_values=True, value_format=".1f", backend="matplotlib"
        )
...
class TestSubplots:
    ...
    def test_create_subplot_grid_with_titles(self):
        ...
        titles = ["A", "B", "C", "D"]
        fig = create_subplot_grid(
            rows=2, cols=2, subplot_titles=titles, backend="plotly"
        )
    ...
    def test_create_subplot_grid_with_specs(self):
        ...
        fig = create_subplot_grid(rows=2, cols=2, specs=specs, backend="plotly")
...
class TestIntegration:
    ...
    def test_distance_matrix_in_subplot(self):
        ...
        heatmap_fig = plot_heatmap(data, backend="plotly")
    ...
    def test_matplotlib_workflow(self):
        ...
        ax_heat = plot_heatmap(
            data, config=PlotConfig(title="Heatmap"), backend="matplotlib"
        )
