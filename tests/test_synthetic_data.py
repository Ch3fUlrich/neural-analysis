...
class TestGenerateData:
    ...
    def test_generate_data_regression(self) -> None:
        ...
        assert data.shape == (100, 5)
        assert isinstance(labels, (np.ndarray, dict))
    ...
    def test_generate_data_position_trajectory(self) -> None:
        ...
        assert data.shape == (100, 2)
        assert isinstance(labels, (dict, np.ndarray))
...
class TestGenerateDataHeadDirection:
    ...
    def test_generate_data_head_direction_basic(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="head_direction", n_samples=100, n_cells=10
            )
            assert isinstance(result, dict)
            assert "activity" in result
        except Exception:
...
class TestGenerateDataPlaceCells:
    ...
    def test_generate_data_place_cells_1d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="place", n_samples=100, n_cells=10, n_dims=1
            )
            assert isinstance(result, dict)
            assert "activity" in result
        except Exception:
    ...
    def test_generate_data_place_cells_2d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="place", n_samples=100, n_cells=10, n_dims=2
            )
            assert isinstance(result, dict)
        except Exception:
            pass
    ...
    def test_generate_data_place_cells_3d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="place", n_samples=100, n_cells=10, n_dims=3
            )
            assert isinstance(result, dict)
        except Exception:
            pass
...
class TestGenerateDataGridCells:
    ...
    def test_generate_data_grid_cells_1d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="grid", n_samples=100, n_cells=10, n_dims=1
            )
            assert isinstance(result, dict)
        except Exception:
            pass
    ...
    def test_generate_data_grid_cells_2d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="grid", n_samples=100, n_cells=10, n_dims=2
            )
            assert isinstance(result, dict)
        except Exception:
            pass
    ...
    def test_generate_data_grid_cells_3d(self) -> None:
        ...
        try:
            result = generate_data(
                dataset_type="grid", n_samples=100, n_cells=10, n_dims=3
            )
            assert isinstance(result, dict)
        except Exception:
            pass
