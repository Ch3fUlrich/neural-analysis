...
class PlotGrid:
    ...
    def _plot_spec_matplotlib(
        ...
        if spec.plot_type == "scatter":
            ...
            if spec.show_points:
                ax.scatter(
                    x, y, c="black", s=spec.marker_size or 5, alpha=0.3, zorder=3
                )
    ...
    def _plot_spec_plotly(
        ...
        if spec.plot_type == "scatter":
            ...
            # 3D wall textures are not implemented for plotly backend yet
            # Return None so caller skips adding a trace for this subplot
            print(
