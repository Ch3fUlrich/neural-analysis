# Python 3.14 → 3.12 Migration Summary

## Date: 2025-11-06

## Reason for Downgrade
Python 3.14 is too new for the scientific Python ecosystem. Key packages (numba, umap-learn) lack pre-built wheels for Python 3.14, requiring complex LLVM builds that aren't practical for CI/CD.
